...
static void Main_MenuDraw( void ) {
	...
	else
	{
		...
		UI_DrawString( 320, 400, "OpenArena(c) 2005-2020 OpenArena Team", UI_CENTER|UI_SMALLFONT, color );
		UI_DrawString( 320, 414, "OpenArenaPlus+ by Danil_Dm 2019-2020", UI_CENTER|UI_SMALLFONT, color );
		UI_DrawString( 320, 428, "CustomMod-The Eazy Modding Tool", UI_CENTER|UI_SMALLFONT, color );
		UI_DrawString( 320, 444, "Platform:Android,Windows,Psp(beta)", UI_CENTER|UI_SMALLFONT, color );
                
                //Draw version.
                UI_DrawString( 640-40, 480-14, "^71.2.2", UI_SMALLFONT, color );
