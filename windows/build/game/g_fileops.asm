...
;30:================
;31:readFile_int
;32:This parses an integer for the "tag" specified (cnf)
;33:================
;34:*/
;35:void readFile_int( char **cnf, int *v )
;36:{
line 40
;37:	char *t;
;38:
;39:	//COM_MatchToken(cnf, "=");
;40:	t = COM_ParseExt( cnf, qfalse );
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
;46:	{
line 47
;47:		COM_ParseWarning( "expected '=' before \"%s\"", t );
ADDRGP4 $64
ARGP4
ADDRLP4 0
INDIRP4
...
;53:================
;54:readFile_string
;55:This parses a literal string for the "tag" specified
;56:Color characters and escape sequences are parsed as well. 
;57:================
;58:*/
;59:void readFile_string( char **cnf, char *s, int size )
;60:{
line 64
;61:	char *t;
;62:
;63:	//COM_MatchToken(cnf, "=");
;64:	s[ 0 ] = '\0';
ADDRFP4 4
INDIRP4
CNSTI1 0
...
;67:	{
line 68
;68:		COM_ParseWarning( "expected '=' before \"%s\"", t );
ADDRGP4 $64
ARGP4
ADDRLP4 0
INDIRP4
...
;86:================
;87:writeFile_int
;88:This writes an integer to the file.
;89:Since there is no logic as to where it writes, it must be called "just-in-time."  
;90:================
;91:*/
;92:void writeFile_int( int v, fileHandle_t f )
;93:{
line 96
;94:	char buf[ 32 ];
;95:
;96:	Com_sprintf( buf, sizeof( buf ), "%d", v );
ADDRLP4 0
ARGP4
CNSTI4 32
ARGI4
...
pop
line 97
;97:	trap_FS_Write( buf, strlen( buf ), f );
ADDRLP4 0
ARGP4
ADDRLP4 32
ADDRGP4 strlen
...
;101:/*
;102:================
;103:writeFile_string
;104:This writes a string to the file. 
;105:Since there is no logic as to where it writes, it must be called "just-in-time."
;106:================
;107:*/
;108:void writeFile_string( char *s, fileHandle_t f )
;109:{
line 112
;110:	char buf[ MAX_STRING_CHARS ];
;111:
;112:	buf[ 0 ] = '\0';
ADDRLP4 0
CNSTI1 0
...
EQI4 $82
line 115
;114:		//Q_strcat(buf, sizeof(buf), s);
;115:		Q_strncpyz( buf, s, sizeof( buf ) );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
pop
line 116
;116:		trap_FS_Write( buf, strlen( buf ), f );
ADDRLP4 0
ARGP4
ADDRLP4 1024
ADDRGP4 strlen
